            ...
            if (movie.media_type === "movie") {
                ...
                return `<article class="movieListItem w-full h-[150px] flex gap-[.5rem] text-[#f8B319] border border-[#ffb319] movie cursor-pointer" data-id="${movie.id}">
                    <div class="w-[100px] shrink-0 relative flex items-center justify-center">
                        ...
                        <img loading="lazy" class="${movie.poster_path ? 'h-full' : ''}" src="${currentPosterImage}" srcset="${movie.poster_path ? posterSrcset(movie.poster_path) : ''}" sizes="100px" alt="${movie.title}" onload="this.closest('article').querySelector('.loading').classList.add('invisible')">
                    </div>
                ...
                return `<article class="movieListItem w-full h-[150px] flex gap-[.5rem] text-[#f8B319] border border-[#ffb319] person cursor-pointer" data-id="${movie.id}">
                    <div class="w-[100px] flex items-center justify-center shrink-0 relative">
                        ...
                        <img loading="lazy" class="${movie.profile_path ? 'h-full' : ''}" src="${currentProfileImage}" srcset="${movie.profile_path ? profileSrcset(movie.profile_path) : ''}" sizes="100px" alt="${movie.name}" onload="this.closest('article').querySelector('.loading').classList.add('invisible')">
                    </div>
                    <div class="summaryDescription">
                ...
                return `<article class="movieListItem w-full h-[150px] flex gap-[.5rem] text-[#f8B319] border border-[#ffb319] movie cursor-pointer" data-id="${movie.id}">
                    <div class="w-[100px] shrink-0 relative">
                        ...
                        <img loading="lazy" class="${movie.poster_path ? 'h-full' : ''}" src="${currentPosterImage}" srcset="${movie.poster_path ? posterSrcset(movie.poster_path) : ''}" sizes="100px" alt="${movie.name}" onload="this.closest('article').querySelector('.loading').classList.add('invisible')">
                    </div>
                    <div class="summaryDescription">
                        <h1 class="text-[1.4rem] font-bold line-clamp-1">${movie.name}</h1>
